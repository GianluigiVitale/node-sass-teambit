...
function mostraNascondiMenuATendina() {
  // // questa funzione al click dell'icona dell'hamburgher mostra il menu a tendina e l'icona della X mentre quando si clicca la X nasconde il menu a tendina e mostra l'hamburgher
  $('.icona .fa-bars').click(function () {
    // quando si clicca l'hamburgher mostra l'icona della X e il menu a tendina
    $(this).hide();
    $('.icona .fa-times').show();
    $('.hamburger-menu').show();
...
__webpack_require__(/*! D:\Users\Gianluigi\Desktop\BooleanLezioniEdEsercizi\EserciziPomeriggio\04-01\node-sass-teambit\src\js\main.js */"./src/js/main.js");
module.exports = __webpack_require__(/*! D:\Users\Gianluigi\Desktop\BooleanLezioniEdEsercizi\EserciziPomeriggio\04-01\node-sass-teambit\src\css\style.scss */"./src/css/style.scss");
